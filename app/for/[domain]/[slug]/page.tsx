...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/for/${domain}/${slug}/` },
  };
}
      ...
      <article className="detail">
        ...
        {!entry ? (
          ...
          <>
            ...
            <dl className="meta">
              <div><dt>Last checked</dt><dd className="stamp mono">{entry.last_verified}</dd></div>
              <div><dt>How we ranked these</dt><dd>{entry.method.how}</dd></div>
              ...
              <div><dt>What “blind tests” means</dt><dd>{entry.method.blind_note}</dd></div>
            </dl>
